...
export default class Timeline extends PureComponent {
  ...
  render() {
    this.flatListRef = this.props.isUsingFlatlist ? (<FlatList
  ...
  scrollFlatListToBottom() {
    this._requireFlatList();
    this.flatListRef?.scrollToBottom();
  }

  _requireFlatList() {
    if (!this.props.isUsingFlatlist) {
      throw 'Only supported when using FlatList';
    }
  }
